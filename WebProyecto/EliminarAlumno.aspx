<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarAlumno.aspx.cs" Inherits="WebTarea6.EliminarAlumno" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="row">
                 <h3> <asp:Label ID="Label9" runat="server" Text="Eliminar Estudiante"></asp:Label></h3>
                <div class="col-4">
   ...
   &nbsp;
        ...
        <br />
           &nbsp;  <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" OnClick="btnEliminar_Click" style="height: 50px"  Width="100px" />
             &nbsp;
