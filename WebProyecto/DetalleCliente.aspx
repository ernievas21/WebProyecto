<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalleCliente.aspx.cs" Inherits="WebTarea6.DetalleCliente" %>
    ...
    <form id="form1" runat="server">
        <div>
             <center>
                <tr>
                 <td>
                     <h2><asp:Label ID="Label1" runat="server" Text="Detalle de Clientes"></asp:Label></h2>
                 </td> 
                     </center>
                </tr>
<tr>
    <td>
       &nbsp;  <b> <asp:Label ID="Label2" runat="server" Text="Listado de Clientes"></asp:Label>  </b>
    </td>
            ...
            <br />
              ...
              <tr>
                     <td>
                        ...
                        &nbsp;   <asp:Label ID="Label3" runat="server" Text="Codigo Cliente:"></asp:Label>
                     </td>
                     <td>
